...
{
    public class PostGisDataMigrationInterpreter : AbstractDataMigrationInterpreter, IDataMigrationInterpreter 
    {
        ...
        public PostGisDataMigrationInterpreter(
...
//                builder.Append(GetTypeName(_dialectLazy.Value, command.DbType, command.Length, command.Precision, command.Scale));
        ...
        public static string GetSpatialTypeName(Dialect dialect, DbType dbType, int? length, byte precision, byte scale) {
            return "1";
        }
